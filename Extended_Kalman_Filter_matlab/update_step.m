function [x_state, delta_x_p, P_p]= update_step(x_m, delta_x_m, dt,  P_m, encoders)
...
delta_fi_p=delta_x_p(7:9);
delta_q_p=quatmultiply(map_q(delta_fi_p)',q_m')';

x_state(1:6,1)=x_m(1:6)+dt*delta_x_p(1:6);
x_state(7:10,1)=x_m(7:10)+dt*delta_q_p;
x_state(11:28,1)=x_m(11:28)+dt*delta_x_p(10:27);
